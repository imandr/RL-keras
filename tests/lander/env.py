...
class LunarLanderEnv(gym.Env):
    ...
    def __init__(self):
        ...
        high = np.array([np.inf]*9)  # useful range is -1 .. +1, but spikes can be higher
    ...
    def step(self, action):
        ...
        if (self.continuous and action[0] > 0.0) or (not self.continuous and action==2):
            ...
            #ivm
            if self.fuel is None or self.fuel > 0.0:
                ...
                if self.fuel is not None:
                    self.fuel -= MAIN_ENGINE_POWER*m_power
        ...
        if (self.continuous and np.abs(action[1]) > 0.5) or (not self.continuous and action in [1,3]):
            ...
            if self.fuel is None or self.fuel > 0.0:
                ...
                #ivm
                if self.fuel is not None:
                    self.fuel -= SIDE_ENGINE_POWER*s_power
        ...
        state = [
            ...
            self.fuel/FUEL_CAPACITY if self.fuel is not None else 1.0
            ]
        assert len(state)==9
        ...
        #if done:
        #    print "x:", self.lander.position.x
    ...
    def render(self, mode='human'):
        ...
        if FUEL_CAPACITY is not None:
            ...
            self.viewer.draw_polygon([(10/SCALE, H/2), (20/SCALE, H/2), 
                    (20/SCALE, H/2+fuel_y/SCALE), (10/SCALE, H/2+fuel_y/SCALE)],
                    color = (0.9, 0.5, 0.5))
                
            self.viewer.draw_polyline([(10/SCALE, H/2), (20/SCALE, H/2), 
                    (20/SCALE, H/2+100/SCALE), (10/SCALE, H/2+100/SCALE)],
                    color = (0.9, 0.5, 0.5))
