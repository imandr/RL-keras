...
class MountainCarEnv(gym.Env):
    ...
    def step(self, action):
        ...
        return np.array(self.state), reward, goal, {}
    ...
    def randomStep(self):
        state0 = np.array((self.np_random.uniform(low=self.min_position, high=self.max_position),
        ...
        state1, reward, done, info = self.step(action)
