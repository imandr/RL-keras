...
class CartPoleAgent(MultiDQNAgent):
    ...
    def create_model(self, inp_width, out_width):
        inp = Input((inp_width,))
        dense1 = Dense(40, activation="tanh", name="dense1")(inp)
        dense2 = Dense(100, activation="softplus", name="dense2")(dense1)
        dense3 = Dense(30, activation="softplus", name="dense3")(dense2)
